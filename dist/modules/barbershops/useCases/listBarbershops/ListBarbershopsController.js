...
var ListBarbershopsController_exports = {};
__export(ListBarbershopsController_exports, {
  ListBarbershopsController: () => ListBarbershopsController
});
module.exports = __toCommonJS(ListBarbershopsController_exports);
...
var ListBarbershopsController = class {
  async handle(request, reply) {
    const useCase = import_tsyringe2.container.resolve(ListBarbershopsUseCase);
