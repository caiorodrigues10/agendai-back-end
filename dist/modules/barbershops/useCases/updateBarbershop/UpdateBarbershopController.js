...
var UpdateBarbershopController_exports = {};
__export(UpdateBarbershopController_exports, {
  UpdateBarbershopController: () => UpdateBarbershopController
});
module.exports = __toCommonJS(UpdateBarbershopController_exports);
...
var UpdateBarbershopController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe2.container.resolve(UpdateBarbershopUseCase);
