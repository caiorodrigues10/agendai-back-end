...
var ListServicesController_exports = {};
__export(ListServicesController_exports, {
  ListServicesController: () => ListServicesController
});
module.exports = __toCommonJS(ListServicesController_exports);
...
var ListServicesController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe2.container.resolve(ListServicesUseCase);
