...
CreateUserUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe3.inject)("UserRepository")),
  __decorateParam(1, (0, import_tsyringe3.inject)("HashProvider"))
], CreateUserUseCase);
...
var CreateUserController = class {
  async handle(request, reply) {
    ...
    const createUserUseCase = import_tsyringe4.container.resolve(CreateUserUseCase);
...
var CreateServiceController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe6.container.resolve(CreateServiceUseCase);
...
var ListServicesController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe8.container.resolve(ListServicesUseCase);
...
var GetServiceController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe10.container.resolve(GetServiceUseCase);
...
var UpdateServiceController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe12.container.resolve(UpdateServiceUseCase);
...
DeleteServiceUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe13.inject)("ServiceRepository"))
...
var DeleteServiceController = class {
  async handle(request, reply) {
    const { id } = request.params;
    const useCase = import_tsyringe14.container.resolve(DeleteServiceUseCase);
...
var CreateBarbershopController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe16.container.resolve(CreateBarbershopUseCase);
...
var ListBarbershopsController = class {
  async handle(request, reply) {
    const useCase = import_tsyringe18.container.resolve(ListBarbershopsUseCase);
...
var GetBarbershopController = class {
  async handle(request, reply) {
    const { id } = request.params;
    const useCase = import_tsyringe20.container.resolve(GetBarbershopUseCase);
...
var UpdateBarbershopController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe22.container.resolve(UpdateBarbershopUseCase);
    const updated = await useCase.execute(id, data);
    reply.send({ success: true, data: updated });
  }
};
...
var DeleteBarbershopController = class {
  async handle(request, reply) {
    const { id } = request.params;
    const useCase = import_tsyringe24.container.resolve(DeleteBarbershopUseCase);
    await useCase.execute(id);
    reply.status(204).send();
  }
};
...
var GetScheduleController = class {
  async handle(request, reply) {
    const { id } = request.params;
    const useCase = import_tsyringe26.container.resolve(GetScheduleUseCase);
...
UpdateScheduleUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe27.inject)("BarbershopRepository"))
...
var UpdateScheduleController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe28.container.resolve(UpdateScheduleUseCase);
    const updated = await useCase.execute(id, data);
...
var ListQueueController = class {
  async handle(request, reply) {
    ...
    const listQueueUseCase = import_tsyringe30.container.resolve(ListQueueUseCase);
...
var JoinQueueController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe32.container.resolve(JoinQueueUseCase);
...
var UpdateQueueItemController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe34.container.resolve(UpdateQueueItemUseCase);
...
var DeleteQueueItemController = class {
  async handle(request, reply) {
    const { id } = request.params;
    const useCase = import_tsyringe36.container.resolve(DeleteQueueItemUseCase);
    await useCase.execute(id);
...
GetQueueMetricsUseCase = __decorateClass([
  ...
  __decorateParam(0, (0, import_tsyringe37.inject)("QueueRepository"))
...
var GetQueueMetricsController = class {
  async handle(request, reply) {
    const { barbershopId } = request.query;
    const getQueueMetricsUseCase = import_tsyringe38.container.resolve(GetQueueMetricsUseCase);
...
LoginUseCase = __decorateClass([
  (0, import_tsyringe39.injectable)(),
  __decorateParam(0, (0, import_tsyringe39.inject)("UserRepository")),
  __decorateParam(1, (0, import_tsyringe39.inject)("HashProvider"))
], LoginUseCase);
...
var LoginController = class {
  async handle(request, reply) {
    ...
    const useCase = import_tsyringe40.container.resolve(LoginUseCase);
