...
## Corpus Check
- 418 files · ~139,232 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2793 nodes · 6523 edges · 200 communities (143 shown, 57 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8996ceff`
...
- `scheduleTrialCardCharges()` --indirect_call--> `ChargeTrialEndedSubscriptionsUseCase`  [INFERRED]
  src/shared/infra/cron/trialCardCharges.cron.ts → src/modules/subscriptions/useCases/chargeTrialEnded/ChargeTrialEndedSubscriptionsUseCase.ts
...
### Community 0 - "api.ts"
Cohesion: 0.26
Nodes (26): authenticate(), authorize(), checkDashboardAccess(), checkSubscription(), setRlsContext(), adminRoutes(), adminFinancialRoutes(), apiRoutes() (+18 more)
...
Cohesion: 0.09
Nodes (19): setupSwagger(), adapter, pool, prisma, EnrichedBarbershop, ExpenseRow, FiadoRow, FiadoSummaryRow (+11 more)
...
Cohesion: 0.08
Nodes (15): AppointmentController, ADMIN, otherOwner, CancelAppointmentUseCase, CreateAppointmentUseCase, GetAppointmentUseCase, GetAvailabilityUseCase, ListAppointmentsUseCase (+7 more)
...
Cohesion: 0.09
Nodes (23): ALLOWED_MIME_SET, logger, UploadVideoController, IUploadVideoDTO, IUploadVideoResult, injectable, UploadVideoUseCase, ALLOWED_MIME_SET (+15 more)
...
Cohesion: 0.14
Nodes (9): IGetLogoUploadUrlDTO, IGetLogoUploadUrlResult, inject, inject, inject, ISignedUploadUrlResult, IStorageProvider, IUploadBufferResult (+1 more)

### Community 21 - "IPaymentDTO.ts"
Cohesion: 0.08
Nodes (19): ConfirmLogoUseCase, inject, injectable, DeleteLogoUseCase, inject, injectable, GetLogoUploadUrlUseCase, inject (+11 more)

### Community 22 - "IPaymentResponseDTO"
Cohesion: 0.19
Nodes (11): buildQueueUpdateMessage(), calendarDateParts(), createAppointmentAtomic(), CreatePublicAppointmentUseCase, formatSaoPauloTime(), mapCreatedAppointment(), ReminderResult, scheduledInstant() (+3 more)

### Community 23 - "SubscribeUseCase.ts"
Cohesion: 0.09
Nodes (10): AsaasService, injectable, setupTrialCardSchema, ChargeTrialEndedSubscriptionsUseCase, inject, injectable, SetupTrialCardController, SetupTrialCardUseCase (+2 more)
...
Cohesion: 0.11
Nodes (21): AdminUserController, BlockedEntityAdminController, BlockInput, blockSchema, UnblockInput, unblockSchema, unblockOwnerCpfs(), BlockedEntityType (+13 more)
...
Cohesion: 0.30
Nodes (8): blockOwnerCpfs(), buildSubscriptionRequiredError(), checkCnpjAccess(), SUBSCRIPTION_MESSAGES, SUBSCRIPTION_STATUS_CONFIG, getAvailablePlans(), shouldBlockOwnerCpfsOnDeniedAccess(), subscriptionGrantsAccess()
...
Cohesion: 0.22
Nodes (11): adminCreateBarbershopSchema, adminCreateUserSchema, adminListBarbershopsQuerySchema, adminListBlockedEntitiesQuerySchema, adminListSubscriptionsQuerySchema, adminListUsersQuerySchema, adminUpdateBarbershopStatusSchema, adminUpdateUserSchema (+3 more)

### Community 31 - "LogoController.ts"
Cohesion: 0.15
Nodes (9): ClientPackageStatus, IClientPackageResponseDTO, IPackageSalesSummary, PackagePaymentMethod, ClientPackageRepository, map(), MockClientPackageRepository, IClientPackageRepository (+1 more)
...
Cohesion: 0.11
Nodes (19): IInvoiceResponseDTO, ISubscribeDTO, ISubscriptionResponseDTO, SubscriptionStatus, asaasCreditCardSchema, identificationSchema, SetupTrialCardInput, SubscribeInput (+11 more)
...
Cohesion: 0.09
Nodes (7): adapter, defaultPlans, pool, prisma, IDateProvider, DayjsDateProvider, BcryptHashProvider
...
Cohesion: 0.18
Nodes (18): EmailTemplateId, EmailJobData, emailQueue, emailQueueEvents, redisConnection, enqueueWhatsApp(), getEvents(), getQueue() (+10 more)

### Community 41 - "payments.spec.ts"
Cohesion: 0.23
Nodes (7): ICreateUserDTO, RoleLiteral, publicSelect, CreateUserController, CreateUserUseCase, inject, injectable
...
Cohesion: 0.13
Nodes (17): RedisRateLimitStore, getEvents(), getQueue(), enqueuePostBroadcast(), getEvents(), getQueue(), PostBroadcastJobData, postBroadcastQueue (+9 more)

### Community 47 - "ContactController.ts"
Cohesion: 0.16
Nodes (5): insideRlsTx, rlsExtension, AdminFinancialController, RequestContext, financial
...
Cohesion: 0.11
Nodes (18): CronLogger, TODO: este cron dispara em cada réplica do serviço. Hoje o backend roda em, scheduleAppointmentReminders(), ALLOWED_TABLES, cleanTable(), scheduleCleanOldLogs(), CronLogger, scheduleTrialCardCharges() (+10 more)

### Community 52 - "QueueRepository"
Cohesion: 0.22
Nodes (6): extractBearerToken(), JwtPayload, authenticateOptional(), JwtPayload, queueRoutes(), buildAuthProbeApp()
...
Cohesion: 0.12
Nodes (11): ListPaymentsController, ListPaymentsUseCase, inject, injectable, abacateServiceMock, asaasServiceMock, mockMpCancel, mockMpCard (+3 more)
...
Cohesion: 0.30
Nodes (10): agendaiWordmark(), buildPostSvg(), escapeXml(), formatBRL(), PostSvgInput, renderPostSvgToPng(), resolvePostFontFile(), minimalInput (+2 more)
...
Cohesion: 0.08
Nodes (37): logger, AsaasBillingType, AsaasCustomer, AsaasPayment, AsaasPixQrCode, AsaasRefund, logger, computeProratedAmount() (+29 more)

### Community 106 - "busboy"
Cohesion: 0.11
Nodes (14): billingAddressSchema, cardPayerSchema, CreateCardPaymentInput, createCardPaymentSchema, CreatePixPaymentInput, createPixPaymentSchema, getPaymentStatusSchema, identificationSchema (+6 more)
...
Cohesion: 0.24
Nodes (3): ConfirmAvatarUseCase, inject, injectable
...
Cohesion: 0.08
Nodes (15): AbacateCheckout, AbacateCustomer, AbacatePayService, AbacateProduct, CreateCheckoutInput, EnsureProductInput, injectable, ProratedRefundInput (+7 more)
...
Cohesion: 0.14
Nodes (8): IPaymentRepository, allowDevModeWebhooks(), ProcessAbacateWebhookUseCase, skipApiVerification(), inject, injectable, handleSubscriptionPaymentWebhook(), prismaMock

### Community 141 - "UpdateQueueItemUseCase.ts"
Cohesion: 0.10
Nodes (19): IQueueRepository, DeleteQueueItemController, DeleteQueueItemUseCase, inject, injectable, buildQueueCalledMessage(), buildQueueCancelledMessage(), NotifyQueuePositionUpdatesUseCase (+11 more)
...
Cohesion: 0.08
Nodes (18): AdminBarbershopController, createBarbershopSchema, phoneBR, scheduleItemSchema, updateBarbershopSchema, updateScheduleSchema, CreateBarbershopController, CreateBarbershopUseCase (+10 more)

### Community 148 - "QueueRepository"
Cohesion: 0.22
Nodes (9): updateQueueItemSchema, masterAdmin, spInstant(), staffShop1, staffShop2, todayIsoSP(), UpdateQueueItemController, injectable (+1 more)
...
Cohesion: 0.25
Nodes (9): LoginController, checkLock(), getLockDuration(), getRemainingTTL(), lockTimers, logger, recordFailure(), resetAttempts() (+1 more)
...
Cohesion: 0.10
Nodes (21): AuthConfig, issueAuthSession(), mapRole(), UserLike, GoogleLoginUseCase, mockFindByEmail, mockUser, mockVerifyIdToken (+13 more)

### Community 164 - "sendWhatsAppMessage"
Cohesion: 0.20
Nodes (6): VerifyEmailController, ForgotPasswordController, ForgotPasswordUseCase, injectable, VerifyEmailUseCase, getFrontendUrl()
...
Cohesion: 0.17
Nodes (8): DeleteAccountController, validateDeleteAccount(), DeleteAccountUseCase, inject, injectable, ExportUserDataController, ExportUserDataUseCase, injectable
...
Cohesion: 0.17
Nodes (12): broadcastPostToClients(), logger, mockEnqueue, mockFindMany, mockFindUnique, pngToDataUrl(), CronLogger, dateKeyInSaoPaulo() (+4 more)

### Community 171 - "JoinQueueController.ts"
Cohesion: 0.17
Nodes (14): JoinQueueController, JoinQueueUseCase, inject, injectable, buildQueueJoinedMessage(), logger, notifyCustomerJoinedQueue(), NotifyQueuePositionResult (+6 more)

### Community 178 - "ListSubscriptionsController"
Cohesion: 0.25
Nodes (3): ListSubscriptionsController, expenseCat, serviceCat

### Community 179 - "queue.spec.ts"
Cohesion: 0.16
Nodes (4): IJoinQueueDTO, IQueueItemResponseDTO, MockQueueRepository, QueueWaitEstimate
...
Cohesion: 0.12
Nodes (19): forgotPasswordSchema, googleLoginSchema, loginSchema, phoneBR, refreshSchema, registerSchema, resetPasswordSchema, scheduleItemSchema (+11 more)
...
Cohesion: 0.16
Nodes (14): validateGoogleLogin, validateLogin, mapRole(), MeController, mePreHandler(), validateRefresh, validateRegister, logger (+6 more)
...
Cohesion: 0.26
Nodes (3): assertOwner(), assertPackageBookable(), assertShopAccess()
...
Cohesion: 0.15
Nodes (18): IBillingAddressDTO, ICardPayerDTO, ICreateCardPaymentDTO, ICreatePixPaymentDTO, IMercadoPagoWebhookDTO, IPixQrCodeDTO, PaymentMethod, PaymentProvider (+10 more)
...
- **Why does `AppError` connect `AppError` to `api.ts`, `IFiadoResponseDTO`, `IServiceResponseDTO`, `PostsController.ts`, `IExpenseResponseDTO`, `@types/node`, `index.ts`, `IBarbershopResponseDTO`, `normalizeCpf`, `UpdateQueueItemUseCase.ts`, `appointments.spec.ts`, `IPlanResponseDTO`, `auth.routes.ts`, `sendWhatsAppMessage`, `UpdateBarbershopUseCase`, `RegisterUseCase.ts`, `IPaymentDTO.ts`, `IPaymentResponseDTO`, `ListBarbershopsUseCase`, `QueueRepository`, `blockedEntityService.ts`, `AppointmentController.ts`, `LoginUseCase.ts`, `BarbershopFinancialController.ts`, `queue.spec.ts`, `LogoController.ts`, `AdminDashboardController.ts`, `paymentSchemas.ts`, `assertAppointmentBookable.ts`, `payments.spec.ts`, `assertAppointmentBookable.ts`, `referralService.ts`, `IEmailProvider.ts`, `ListSubscriptionsController`, `queue.spec.ts`, `QueueRepository`, `ForgotPasswordUseCase`, `GcsStorageProvider`, `AppointmentRepository`, `app.ts`, `packageUseCases.ts`, `MercadoPagoService`, `GetBarbershopUseCase.ts`, `CheckInAppointmentController.ts`, `dependencies`, `bcryptjs`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `prisma` connect `AppError` to `IFiadoResponseDTO`, `IServiceResponseDTO`, `PostsController.ts`, `IExpenseResponseDTO`, `AbacatePayService`, `index.ts`, `IBarbershopResponseDTO`, `IPlanResponseDTO`, `IAppointmentResponseDTO`, `sendWhatsAppMessage`, `IPaymentResponseDTO`, `ListBarbershopsUseCase`, `cancelSubscription.spec.ts`, `blockedEntityService.ts`, `LoginUseCase.ts`, `BarbershopFinancialController.ts`, `queue.spec.ts`, `AdminDashboardController.ts`, `paymentSchemas.ts`, `assertAppointmentBookable.ts`, `planEconomics.ts`, `AdminNotificationController.ts`, `google-auth-library`, `IQueueItemResponseDTO`, `assertAppointmentBookable.ts`, `JoinQueueController.ts`, `referralService.ts`, `payments.spec.ts`, `IEmailProvider.ts`, `queue.spec.ts`, `server.ts`, `ForgotPasswordUseCase`, `GcsStorageProvider`, `IAppointmentRepository`, `app.ts`, `MercadoPagoService`, `CheckInAppointmentController.ts`, `dependencies`, `bcryptjs`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `getModuleLogger()` connect `bcryptjs` to `@types/node`, `IStorageProvider`, `UpdateQueueItemUseCase.ts`, `auth.routes.ts`, `IPaymentDTO.ts`, `ListBarbershopsUseCase`, `bruteForceProtection.ts`, `AdminDashboardController.ts`, `emailWorker.ts`, `paymentSchemas.ts`, `appointmentUseCases.ts`, `google-auth-library`, `JoinQueueController.ts`, `referralService.ts`, `index.ts`, `IEmailProvider.ts`, `server.ts`, `ResetPasswordUseCase`, `IAppointmentRepository`, `MercadoPagoService`, `CheckInAppointmentController.ts`?**
